        ...
        <section className="bg-white rounded-[40px] border border-slate-100 shadow-sm p-8 md:p-12 space-y-10 flex-1">
          ...
          <div className="space-y-6 pt-6 border-t border-slate-50">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <Button variant="outline" className="h-16 rounded-2xl border-slate-100 hover:bg-slate-50 font-bold text-slate-600 gap-4 justify-start px-6">
          ...
          <div className="pt-8 mt-auto flex justify-end gap-4">
            <Button variant="ghost" className="rounded-2xl h-14 px-8 font-black text-slate-400">Discard</Button>
