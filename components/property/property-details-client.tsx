...
export function PropertyDetailsClient({ property, initialIsWishlisted }: PropertyDetailsClientProps) {
  ...
  // Sync wishlist state if it changes externally or on mount if not provided
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 pt-24 pb-20">
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col lg:flex-row gap-10 pb-24 md:pb-0">
                ...
                <Dialog>
                  ...
                  <DialogContent className="max-w-md rounded-[40px] border-none shadow-2xl bg-white p-8">
                    ...
                    <div className="space-y-6 pt-6">
                      ...
                      >
                        {isSubmittingEnquiry ? "Sending..." : "Send Enquiry Now"}
                      </Button>
                    </div>
                  </DialogContent>
                </Dialog>
                  ...
                  <DialogContent className="max-w-md rounded-[40px] border-none shadow-2xl bg-white p-8">
                    ...
                    <div className="space-y-6 pt-6">
                      ...
                      <Button 
                        ...
                        className="w-full h-14 rounded-2xl font-black text-lg bg-[#1A56DB]"
                      >
                        {isSchedulingVisit ? "Requesting..." : "Request Visit Now"}
                      </Button>
                    </div>
                  </DialogContent>
                </Dialog>
      ...
      <div className="fixed bottom-6 left-6 right-6 z-50 lg:hidden">
        <div className="bg-white/95 backdrop-blur-md border border-slate-200 rounded-[2.5rem] shadow-[0_8px_32px_0_rgba(0,0,0,0.15)] flex items-center justify-between p-2 gap-2">
            <Dialog>
                <DialogTrigger asChild>
                    <Button variant="outline" className="flex-1 h-14 rounded-[2rem] font-black text-sm border-2 border-slate-100 bg-white">
                        <Calendar className="w-4 h-4 mr-2 text-[#1A56DB]" />
                        Visit
                    </Button>
                </DialogTrigger>
                <DialogContent className="max-w-md rounded-[40px] border-none shadow-2xl bg-white p-8">
            ...
            <Dialog>
                <DialogTrigger asChild>
                    <Button className="flex-[2] h-14 rounded-[2rem] font-black text-lg bg-[#1A56DB] shadow-xl shadow-[#1A56DB]/20">
                        Enquire Now
                    </Button>
                </DialogTrigger>
                <DialogContent className="max-w-md rounded-[40px] border-none shadow-2xl bg-white p-8">
